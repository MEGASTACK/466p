...
%   matrix which contains S MCMC simulations of length N (Parise S.) 
%   with dimension M. MCMC-simulations can be given as separate
...
% Commented out and neff set to -1 since they were causing divide by zero error (Parise S.)
